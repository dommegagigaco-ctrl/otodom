...
# 4. Filtry lokalizacyjne i cenowe
df_f = sidebar_location_filter(df)

# 5. Definicja wszystkich dostępnych kolumn
all_cols = {
    'url':                                                        'Link',
    'title':                                                      'Tytuł oferty',
    'price':                                                      'Cena',
...
# 7. Sidebar: sortowanie (z pamięcią w URL)
st.sidebar.subheader("🔃 Sortowanie")
sortable = {k: v for k, v in all_cols.items() if k != 'url' and k != 'title'}
...
# 9. Wyświetlanie tabeli tylko z wybranymi kolumnami
